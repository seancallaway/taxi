...
SECRET_KEY = getenv('SECRET_KEY', 'django-insecure-)1xzbj-8$fkz)vcc*%hxx_!!g32k-1=jm8-+j%b_7-@85ot83y')
...
INSTALLED_APPS = [
    'daphne',  # while 3rd party, must be up top
...
DATABASES = {
    'default': {
        ...
        'NAME': getenv('SQL_DATABASE', 'taxi'),
        'USER': getenv('SQL_USER', 'taxi_user'),
